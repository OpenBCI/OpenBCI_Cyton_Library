...
boolean testTurningChannelsOff(void) {
  ...
  Serial.println("#TurningChannelsOff");
  result = assertEqualChar('1', OPENBCI_CHANNEL_OFF_1) && result;
  if (!result) verbosePrintResult(result,"TurningChannelsOff","Channel 1");
  result = assertEqualChar('2', OPENBCI_CHANNEL_OFF_2) && result;
  if (!result) verbosePrintResult(result,"TurningChannelsOff","Channel 2");
  result = assertEqualChar('3', OPENBCI_CHANNEL_OFF_3) && result;
  if (!result) verbosePrintResult(result,"TurningChannelsOff","Channel 3");
  result = assertEqualChar('4', OPENBCI_CHANNEL_OFF_4) && result;
  if (!result) verbosePrintResult(result,"TurningChannelsOff","Channel 4");
  result = assertEqualChar('5', OPENBCI_CHANNEL_OFF_5) && result;
  if (!result) verbosePrintResult(result,"TurningChannelsOff","Channel 5");
  result = assertEqualChar('6', OPENBCI_CHANNEL_OFF_6) && result;
  if (!result) verbosePrintResult(result,"TurningChannelsOff","Channel 6");
  result = assertEqualChar('7', OPENBCI_CHANNEL_OFF_7) && result;
  if (!result) verbosePrintResult(result,"TurningChannelsOff","Channel 7");
  result = assertEqualChar('8', OPENBCI_CHANNEL_OFF_8) && result;
  if (!result) verbosePrintResult(result,"TurningChannelsOff","Channel 8");

  result = assertEqualChar('Q', OPENBCI_CHANNEL_OFF_9) && result;
  if (!result) verbosePrintResult(result,"TurningChannelsOff","Channel 9");
  result = assertEqualChar('W', OPENBCI_CHANNEL_OFF_10) && result;
  if (!result) verbosePrintResult(result,"TurningChannelsOff","Channel 10");
  result = assertEqualChar('E', OPENBCI_CHANNEL_OFF_11) && result;
  if (!result) verbosePrintResult(result,"TurningChannelsOff","Channel 11");
  result = assertEqualChar('R', OPENBCI_CHANNEL_OFF_12) && result;
  if (!result) verbosePrintResult(result,"TurningChannelsOff","Channel 12");
  result = assertEqualChar('T', OPENBCI_CHANNEL_OFF_13) && result;
  if (!result) verbosePrintResult(result,"TurningChannelsOff","Channel 13");
  result = assertEqualChar('Y', OPENBCI_CHANNEL_OFF_14) && result;
  if (!result) verbosePrintResult(result,"TurningChannelsOff","Channel 14");
  result = assertEqualChar('U', OPENBCI_CHANNEL_OFF_15) && result;
  if (!result) verbosePrintResult(result,"TurningChannelsOff","Channel 15");
  result = assertEqualChar('I', OPENBCI_CHANNEL_OFF_16) && result;
  if (!result) verbosePrintResult(result,"TurningChannelsOff","Channel 16");
...
boolean testChannelSettingCommands() {
  ...
  Serial.println("#ChannelSettingCommands");
